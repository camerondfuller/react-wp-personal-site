...
if($lychee_opt['show_search_intro'] == true){ ?>

		<div class="top-baner half-height">
			
			<?php 
			$intro_bg_id 	= $lychee_opt['search_intro_background_image'];
			$intro_bg 		= wp_get_attachment_image_src($intro_bg_id, 'full');
			$intro_title 	= $lychee_opt['search_intro_title'];
			$intro_subtitle = $lychee_opt['search_intro_subtitle'];
...
<div class="main-wrapp pad120"> 
   <div class="container">
	      <div class="row">
	     	<div class="col-md-12">
	     	  <div class="subtitle">
				<h3><?php printf( __( 'Search Results for: %s', 'lychee' ), get_search_query() ); ?></h3>
			 </div>
	     	</div>
	      </div>
